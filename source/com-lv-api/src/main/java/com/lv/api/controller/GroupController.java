...
import com.lv.api.dto.group.GroupAdminDto;
import com.lv.api.exception.RequestException;
import com.lv.api.form.group.CreateGroupForm;
import com.lv.api.form.group.UpdateGroupForm;
import com.lv.api.mapper.GroupMapper;
import com.lv.api.storage.criteria.GroupCriteria;
...
public class GroupController extends ABasicController{
    ...
    public ApiMessageDto<ResponseListObj<GroupAdminDto>> getListCombox(@RequestParam(name = "kind", required = false) Integer kind){
        GroupCriteria groupCriteria = new GroupCriteria();
        if(kind != null) {
            groupCriteria.setKind(kind);
        }
