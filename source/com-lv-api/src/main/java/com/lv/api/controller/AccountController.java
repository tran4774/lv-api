...
import com.lv.api.utils.AESUtils;
import com.lv.api.utils.ConvertUtils;
...
public class AccountController extends ABasicController{
    ...
    public ApiMessageDto<LoginDto> login(@Valid @RequestBody LoginForm loginForm, BindingResult bindingResult) {
        ...
        if (Objects.equals(loginForm.getApp(), Constants.APP_CMS) && Objects.equals(account.getKind(), Constants.USER_KIND_CUSTOMER)) {
